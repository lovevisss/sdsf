...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\EthicsAcademicViolation>
 */
class EthicsAcademicViolationFactory extends Factory
{
    protected $model = EthicsAcademicViolation::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'violation_type' => $this->faker->numberBetween(16, 22),
