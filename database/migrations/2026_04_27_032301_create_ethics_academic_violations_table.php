...
return new class extends Migration
{
    ...
    {
        Schema::create('ethics_academic_violations', function (Blueprint $table): void {
            $table->id();
            ...
            $table->index(['violation_type', 'violation_at'], 'eav_type_at_idx');
            $table->index(['violator_user_id', 'violation_at'], 'eav_user_at_idx');
            $table->index(['staff_no', 'violation_at'], 'eav_staff_at_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('ethics_academic_violations');
    }
};
