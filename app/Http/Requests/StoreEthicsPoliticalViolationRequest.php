...
class StoreEthicsPoliticalViolationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'violation_type' => ['required', 'integer', 'between:1,7'],
    ...
    {
        return [
            'violation_type.between' => '违规类型必须是1-7之间的编号。',
            'deduction_points.max' => '思想政治素养单次扣分不能超过25分。',
