...
class StoreEthicsAcademicViolationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'violation_type' => ['required', 'integer', 'between:16,22'],
    ...
    {
        return [
            'violation_type.between' => '违规类型必须是16-22之间的编号。',
            'deduction_points.max' => '学术科研道德单次扣分不能超过25分。',
