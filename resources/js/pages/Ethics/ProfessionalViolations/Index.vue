    ...
    <div class="px-4 py-8 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-7xl space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">为人师表违规手工登记</h1>
            <p class="mt-2 text-gray-600 dark:text-gray-400">总分100分中的为人师表25分，按违规类型手工登记扣分并自动汇总。</p>
          </div>
...
const applyStaffFilter = (): void => {
  ...
  router.get('/ethics/professional-violations', { staff_no: form.staff_no }, { preserveState: true })
}
...
const pickStaffSummary = (item: StaffSummary): void => {
  ...
  router.get('/ethics/professional-violations', { staff_no: item.staff_no }, { preserveState: true })
}
