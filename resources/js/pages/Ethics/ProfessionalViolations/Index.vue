                ...
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-400">
                            总分100分中的为人师表20分，按违规类型手工登记扣分并自动汇总。
                        </p>
                    </div>
                    <Link
...
const submit = (): void => {
    ...
    form.post('/ethics/professional-violations', {
        preserveScroll: true,
        onSuccess: () => {
            staffQuery.value = '';
...
const applyStaffFilter = (): void => {
    ...
    router.get(
        '/ethics/professional-violations',
...
const clearStaffFilter = (): void => {
    router.get('/ethics/professional-violations', {}, { preserveState: false });
};
