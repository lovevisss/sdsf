                ...
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-400">
                            总分100分中的学术科研道德20分，按违规类型手工登记扣分并自动汇总。
                        </p>
                    </div>
                    <Link
...
const submit = (): void => {
    ...
    form.post('/ethics/academic-violations', {
        preserveScroll: true,
        onSuccess: () => {
            staffQuery.value = '';
...
const clearStaffFilter = (): void => {
    router.get('/ethics/academic-violations', {}, { preserveState: false });
};
